...
int main() {
    ...
    // vector <int>::iterator it1;   // iterator object. Iterator class is defined in the scope of the container class. Accessed through the scope resolution operator :: . The type of the iterator is bound to the type of the class. Won't work with any other class or templated class. Will only work with a vector of ints.
