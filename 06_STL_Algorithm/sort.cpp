...
int main() {
  // prime numbers < 100 (unsorted)
  vector<int> v1 = {83, 53, 47, 23, 13, 59, 29, 41, 19, 71, 31, 67, 11,
                    2,  97, 7,  61, 73, 3,  79, 37, 43, 17, 5,  89};
  vector<double> v2 = {3.07, 2.49, 3.73, 6.58, 3.3,  2.72, 3.44,
  ...
  sort(v2.begin(), v2.end(), mycomp<int>);
  disp_v(v2);
